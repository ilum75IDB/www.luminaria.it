...
**Data Warehouse Architect & Oracle/PostgreSQL Expert**
...
- **DWH/DBA Project Administration:**
  ...
  - Managed fact tables ingesting up to 800M records per day, requiring advanced partitioning and compression strategies.
