...
| Metrica | Prima | Dopo |
|---------|-------|------|
| {{< glossary term="rpo" >}}RPO{{< /glossary >}} (Recovery Point Objective) | ~10 ore (backup notturno) | < 5 secondi |
| {{< glossary term="rto" >}}RTO{{< /glossary >}} (Recovery Time Objective) | 6+ ore (restore da backup) | < 1 minuto (switchover) |
