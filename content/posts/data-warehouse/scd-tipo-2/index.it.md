...
L'{{< glossary term="etl" >}}ETL{{< /glossary >}} notturno era un semplice {{< glossary term="merge-sql" >}}MERGE{{< /glossary >}}: se il cliente esiste, aggiorna tutti i campi; se non esiste, inserisci.
