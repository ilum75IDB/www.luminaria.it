...
El {{< glossary term="etl" >}}ETL{{< /glossary >}} nocturno era un simple {{< glossary term="merge-sql" >}}MERGE{{< /glossary >}}: si el cliente existe, actualiza todos los campos; si no existe, inserta.
